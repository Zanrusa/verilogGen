...
DICT_TYPE = {0:'or',
             1:'ow'}
class Ui_outputAdd(QtWidgets.QDialog):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Form):
        ...
        self.basicComplist = []
##        self.basicComplist.append(Comp_stypeMember('output',Form))
##        self.basicComplist[0].setGeometry(QtCore.QRect(10, 50, 700, 80))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Output Port Define"))
    ...
    def ifPlus(self):
        _temp =Comp_stypeMember('output',self)
