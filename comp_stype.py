...
class Comp_stypeMember(QtWidgets.QWidget):
    def __init__(self,itype,Form):
        super().__init__(Form)
        self.resize(600, 50)
        self.setupUi(itype,self)
        
    def setupUi(self,itype,Form):
        ...
        if itype == 'output' or itype == 'others':
            self.typeInput.addItem("")
##        self.typeInput.addItem("")
##        self.typeInput.addItem("")
##        self.typeInput.addItem("")
##        self.typeInput.addItem("")
        ...
        self.retranslateUi(itype,Form)
##        self.typeInput.currentTextChanged['QString'].connect(self.ifChanged)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self,itype,Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.name.setText(_translate("Form", "Name"))
        self.type.setText(_translate("Form", "Type"))
        if itype == 'output':
            self.typeInput.setItemText(0, _translate("Form", "output reg"))
            self.typeInput.setItemText(1, _translate("Form", "output wire"))
        elif itype == 'others':
            self.typeInput.setItemText(0, _translate("Form", "reg"))
            self.typeInput.setItemText(1, _translate("Form", "wire"))
        elif itype == 'input' or itype == 'inout' or itype == 'parameter'or itype == 'localparam':
            self.typeInput.setItemText(0, _translate("Form", itype))
        else:
            self.typeInput.setItemText(0, _translate("Form", 'ERROR'))
...
##        self.typeInput.setItemText(5, _translate("Form", "localparam"))
        ...
        if itype == 'input' or  itype == 'output' or  itype == 'inout'or itype == 'others':
            self.valueWidget.hide()
            self.widthWidget.show()
        elif itype == 'parameter' or itype =='localparam':
