...
DICT_TYPE = {0:'iw'}
class Ui_inputAdd(QtWidgets.QDialog):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Form):
        ...
        self.basicComplist = []
##        self.basicComplist.append(Comp_stypeMember('input',Form))
##        self.basicComplist[0].setGeometry(QtCore.QRect(10, 50, 700, 80))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Input Port Define"))
    ...
    def ifPlus(self):
        _temp =Comp_stypeMember('input',self)
