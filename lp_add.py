...
DICT_TYPE = {0:'l'}
class Ui_lpAdd(QtWidgets.QDialog):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Form):
        ...
        self.basicComplist = []
##        self.basicComplist.append(Comp_stypeMember(itype='localparam',Form=Form))
##        self.basicComplist[0].setGeometry(QtCore.QRect(10, 50, 700, 80))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Localparam Type Define"))
    ...
    def ifPlus(self):
        _temp =Comp_stypeMember('localparam',self)
    ...
    def ifAddgroup(self):
        ...
        for comp in self.basicComplist:
            ...
            if _index == 0:
                self.lplist[_iname] = moduleType.lpType(iname=_iname,ivalue=_ivalue)
            else:
                pass
