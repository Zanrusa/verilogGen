...
DICT_TYPE = {0:'bw'}
class Ui_inoutAdd(QtWidgets.QDialog):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Form):
        ...
        self.basicComplist = []
##        self.basicComplist.append(Comp_stypeMember('inout',Form))
##        self.basicComplist[0].setGeometry(QtCore.QRect(10, 50, 700, 80))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Inout Port Define"))
    ...
    def ifPlus(self):
        _temp =Comp_stypeMember('inout',self)
    ...
    def loadElement(self,inout):
        for name in inout[0]:
            _temp = Comp_stypeMember('inout',self)
            _temp.nameEdit.setText(inout[0][name].getName)
            _temp.typeInput.setCurrentIndex(0)
            _temp.widthEdit.setText(str(others[0][name].getWidth))
            _temp.setGeometry(QtCore.QRect(10, 50+len(self.basicComplist)*70, 700, 80))
            self.basicComplist.append(_temp)
